#!r6rs
(library (intseq utils vector-extra-utils)
  (export vector-grow)
  (import (rnrs base (6)))
...
;; This small piece of code by karttu, 2012-12-17 for example for Racket R5RS and R6RS
...
) ;; End of module vector-extra-utils.ss
